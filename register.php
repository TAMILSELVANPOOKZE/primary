         ...
         <form action="save_register.php" method="post" >
             <table  align="center">
              <tr><td style="font-weight: bold;">
                ...
                <tr><td style="font-weight: bold;">
                       age </td><td><input type="text" name="age"></td></tr> 
                         <tr>
                      	<td></td>
                      </tr> <tr>
                        <td></td>
                     ...
                     <tr>
                        ...
                        <td></td>
                         ...
                         <td style="font-weight: bold;">  
                            mobile.no</td><td><input type="text" name="mobile" maxlength="10"></td></tr>
                     <td> </td>
                      <tr>
                      	<td></td>
                      </tr>
                      ...
                      <tr>
                       ...
                       <tr>
                       	<td></td><td><button type="submit" id="btn">Submit</button> </td></tr>
